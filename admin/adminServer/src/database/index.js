...
const profileVistModel=require("./models/profilevisit.js")
...
db.profilevist=profileVistModel(db.sequelize, DataTypes);
...
//create a Relationshop between user another user and follow table
...
db.user.hasMany(db.profilevist, {
  foreignKey: { name: "user_id", allowNull: false },
});
db.profilevist.belongsTo(db.user, {
  foreignKey: { name: "user_id", allowNull: false },
});
